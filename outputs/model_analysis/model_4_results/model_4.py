...
class DocumentProcessor:
    ...
    def initialize_apis(self):
        models = []
        generation_config = {
    "temperature": 0.3,   # Low to moderate randomness for focused results
    "top_p": 0.85,        # Concentrate probability mass on the most likely tokens
    "top_k": 30,          # Consider a smaller pool of tokens for more deterministic outputs
